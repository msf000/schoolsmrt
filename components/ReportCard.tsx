...
import { getReportHeaderConfig, getExams, getExamResults } from '../services/storageService';
import { generateNarrativeInsights } from '../services/geminiService';
import { calculateGrowthMetrics } from '../services/analysisService';
import { Printer, Download, Sparkles, Star, Target, Calendar, User, FileText, Loader2, ChevronRight, Share2, Bot, ArrowUpCircle } from 'lucide-react';
...
const ReportCard: React.FC<Props> = ({ student, performance, attendance, onClose }) => {
    ...
    const stats = useMemo(() => {
        ...
        return { avg, abs, growthVal, myPerf, myAtt };
            ...
            <div className="bg-white w-full max-w-5xl h-full rounded-[3.5rem] shadow-2xl flex flex-col overflow-hidden relative">
                ...
                <div id="report-card-printable" className="flex-1 overflow-y-auto p-12 custom-scrollbar bg-white print:p-0">
                    <div className="max-w-4xl mx-auto border-[12px] border-double border-slate-100 p-12 relative overflow-hidden print:border-none">
                        ...
                        <div className="grid grid-cols-4 gap-6 mb-12 bg-slate-50 p-8 rounded-[2.5rem]">
                            ...
                            <div className="flex flex-col items-center justify-center border-r border-slate-200">
                                ...
                                <div className="text-4xl font-black text-slate-900">{stats.avg}%</div>
                            </div>
                            <div className="flex flex-col items-center justify-center border-r border-slate-200">
                                <p className="text-[10px] font-black text-slate-400 uppercase mb-1">نسبة النمو</p>
                                <div className="text-4xl font-black text-emerald-600">+{stats.growthVal}%</div>
                            </div>
                        </div>
